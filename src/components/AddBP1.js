         ...
         return(
            ...
            style={styles.container}>
                ...
                style={{backgroundColor:'#2B3B4B'}}>
                    <Body>
                        <Text 
                        style={{color:'#8CC7B1'}}>Ajouter un bon plan</Text>
                    </Body>
                    <Right>
                        <Button 
                        transparent
                ...
                tabBgColor='#8CC7B1'>
                        <Tab 
                        heading="Bon plan permanant" 
                        tabStyle={{backgroundColor: '#2B3B4B'}} 
                        textStyle={{color: '#D3D3D3'}} 
                        activeTabStyle={{backgroundColor: '#8CC7B1'}} 
                        activeTextStyle={{color: 'white', fontWeight: 'bold'}}>
                            <Formbppermanant />
                        </Tab>
                        <Tab 
                        heading="Bon plan occasionnel" 
                        tabStyle={{backgroundColor: '#2B3B4B'}} 
                        textStyle={{color: '#D3D3D3'}} 
                        activeTabStyle={{backgroundColor: '#8CC7B1'}} 
                        activeTextStyle={{color: 'white', fontWeight: 'bold'}}>
